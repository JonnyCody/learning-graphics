...
public:
    ...
    {}
    constant_medium(std::shared_ptr<hittable> b, double d, const color& c)
    ...
    virtual bool hit(const ray& r, double t_min, double t_max, hit_record& rec) const override
    {
        ...
        const bool debugging = enableDebug && random_double_number() < 0.00001;
        ...
        const auto hit_distance = neg_inv_density * log(random_double_number());
