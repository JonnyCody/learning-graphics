...
public:
    ...
    virtual bool scatter(
        ...
        if (cannot_refract || reflectance(cos_theta, refraction_ratio) > random_number_double())
...
public:
    ...
    virtual bool scatter(
            const ray& r_in, const hit_record& rec, color& attenuation, ray& scatter) const override
    {
        return false;
    }
